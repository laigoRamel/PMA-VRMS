<div class="modal fade" id='edit_military'>
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class='modal-body'>
				<div class='row'>
					<div class='col-lg-12'>
						<form action='logic/edit_military_logic.php' method='post'>
						
							<div id='edit_modal_table_military'>
								<div style='display: none;'>
									<td><input type='text' name='military_dataId' readonly /></td>
								</div>
