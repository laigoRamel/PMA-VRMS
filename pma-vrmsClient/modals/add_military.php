<div class="modal fade" id='add_military'>
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class='modal-header'>
				<button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
				<h4 class='modal-title'>Add Military</h4>
			</div>
			<div class='modal-body'>
				<div class='row'>
					<div class='col-lg-12'>
						<form action='logic/add_military_logic.php' method='post'>
							<table>
								<tr>
...
DATA;
									...
									<tr>
										<button type='submit' value='Ok' class="btn btn-default pull-right" data-target="../#afp_home">
