...
<head>
  ...
  <meta http-equiv="pragma" content="no-cache" />
   ...
   <!-- <link rel="stylesheet" type="text/css" href="css/print.css">-->
    ...
    <div id='hide-wrapper' class="wrapper">
...
VEHICLE;
    ...
    <script>
      $('#print-btn').click(function(){
          ...
          $('#print-address').html($('#view-address').val());
          $('#print-office').html($('#view-office').val());
