...
$resultForm1 = $conn->query("SELECT a_applicantId FROM form1_applicantpd WHERE a_status='pending'");
$resultForm2 = $conn->query("SELECT m_militaryId FROM form2_militarypd WHERE m_status='pending'");
