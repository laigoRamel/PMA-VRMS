...
<html>
<head>
  <title>Transfer Vehicle: Military</title>
  ...
  <script src="bootstrap/js/bootstrap.min.js"></script>
   ...
   <script type="text/javascript" src='../selectize/js/standalone/selectize.min.js'></script>
    ...
    <?php include('logic/military_vehicleStatus_logic.php'); ?>
    ...
    <div id='existing-modal' class="modal fade" tabindex="-1" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action='logic/military_transfer_to_existing_logic.php' method='post'>
            <div class="modal-body">
  ...
  <script>
    ...
    <script>
      ...
      /** $('#transfer-modal-existing').click(function(){
       ...
       $.get(window.location.origin+'/PMA-VRMS/trunk/pma-vrmsSuperAdmin/logic/ajax_military_list.php', function(response){
