...
<html>
<head>
  <title>Transfer Vehicle: Applicant</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="applicant_vehicles.php">For Civilian</a></li>
  ...
  <script>
    ...
    <script>
      ...
      /** $('#transfer-modal-existing').click(function(){
       ...
       $.get(window.location.origin+'/PMA-VRMS/trunk/pma-vrmsAdmin/logic/ajax_applicant_list.php', function(response){
