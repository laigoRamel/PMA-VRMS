                    ...
                    <div class="panel-body">
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                          ...
                          <div>
                            ...
                            <input type="file" id="img_edit" name="b_profile" required></span>
            ...
            <td>
              ...
              <select name="yearModel" class="form-control name_list" required>
                ...
                <option value="2020" <?php if($yearModel=="2020") echo 'selected="selected"'; ?> >2020</option>
                    ...
                    <!-- submit button -->
                    <div class="panel-body">
                        <button type="button" class="btn btn-primary btn-lg pull-right" value="Ok" onclick="return confirm('Edited and Updated?')"> 
