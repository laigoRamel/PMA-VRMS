      ...
      <header class="main-header">
        ...
        <div class="logo">
          <span class="logo-mini">
              <img src="dist/img/seal.png" style="width:30px;height:30px;">
          </span>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- Dashboard -->
            <li class="active"><a href="#"><i class="glyphicon glyphicon-dashboard"></i> <span>Dashboard</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#">Camp Allen/Navybase</a></li>
                <li><a href="#">AFP</a></li>
              </ul>
            </li>
