...
<body class="hold-transition skin-black sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- Vehicle Log -->
            <li><a href="../pma-vrmsAdmin/vehicleLog.php"><i class="glyphicon glyphicon-road"></i> <span>Vehicle Log</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../pma-vrmsAdmin/form1.php">Camp Allen/Navybase</a></li>
                <li><a href="../pma-vrmsAdmin/form2.php">AFP</a></li>
              </ul>
            </li>
    ...
    <script src="../pma-vrmsAdmin/js/print.js" type="text/javascript"></script>
	<script src="../pma-vrmsAdmin/bootstrap/js/jquery.sortelements.js" type="text/javascript"></script>
	<script src="../pma-vrmsAdmin/bootstrap/js/jquery.bdt.js" type="text/javascript"></script>
	<script>
...
<!-- NEW -->
    <script>
    	$('table').on('click', '.reset', function(){
    		...
    		var element = $(this);
    		$.post(window.location.origin+'/PMA-VRMS/trunk/login/reset_account_logic.php', {id: id}, function(response){
